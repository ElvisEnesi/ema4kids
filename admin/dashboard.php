...
<head>
    ...
    <title>Ema4kids Admin Dashboard</title>
    ...
    <div class="dashboard_container">
        <aside>
            ...
            <div class="aside_links">
                <a href="<?= site_url ?>admin/dashboard.php" class="active"><ion-icon name="grid-outline"></ion-icon> Dashboard Overview</a>
        ...
        <main>
            ...
            <div class="greet">Welcome back, <?= htmlspecialchars($user_data['lastname'] . " " . $user_data['firstname'] . " " . $user_data['middlename'], ENT_QUOTES, "UTF-8") ?> &#128075;</div>
            <div class="overview">
            ...
            <?php
                ...
                $select_activity = mysqli_prepare($conn, "SELECT ac.uuid AS uuid, ac.activity AS activity, ac.date AS date, ad.uuid 
                AS admin_uuid, ad.encrypted_email AS email FROM activity_log AS ac JOIN admin_tbl AS ad ON ac.uuid = ad.uuid
                WHERE ac.uuid = ? ORDER BY ac.date DESC");
                //bind parameters
