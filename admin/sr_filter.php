        ...
        <main>
            ...
            <?php
                ...
                if (isset($_GET['filter'])) {
                    ...
                    $select_sr = mysqli_prepare($conn, "SELECT * FROM sr_tbl WHERE status = ?");
                    // bind parameters
                    mysqli_stmt_bind_param($select_sr, "s", $filter);
                    // execute statement
                        ...
                        echo "<table>";
                            ...
                            while ($sr = mysqli_fetch_assoc($select_sr)) {
                                echo "<tr>";
                                    ...
                                    echo '<td><a href="edit_sr.php?uuid=' . htmlspecialchars($sr['sr_uuid'], ENT_QUOTES, 'UTF-8') . '">Click</a></td>';
                                    echo '<td><a href="delete_sr.php?uuid=' . htmlspecialchars($sr['sr_uuid'], ENT_QUOTES, 'UTF-8') . '" class="danger">Click</a></td>';
                                echo "</tr>";
                            }
                        echo "</table>";
                    } else {
