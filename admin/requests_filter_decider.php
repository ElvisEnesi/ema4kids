<?php
    ...
    if (isset($_POST['all'])) {
        ...
        header("location: ". site_url . "admin/requests_filter.php?filter=approved");
        exit();
    } elseif (isset($_POST['pending'])) {
        // redirect to pending requests page
        header("location: ". site_url . "admin/requests_filter.php?filter=pending");
        exit();
    } elseif (isset($_POST['correct'])) {
        // redirect to correct requests page
        header("location: ". site_url . "admin/requests_filter.php?filter=correct");
        exit();
    } else {
        die("role not set");
    }
