...
<body>
    ...
    <div class="blog_holder">
        <div class="blog_carrier">
            <img src="<?= site_url ?>images/uj.jpeg" alt="image" 
            onclick="window.location.href='https://www.unijos.edu.ng/'">
            <h3>University of Jos</h3>
        </div>
        <div class="blog_carrier">
            <img src="<?= site_url ?>images/film.jpeg" alt="blog image" 
            onclick="window.location.href='https://nfi.edu.ng/'">
            <h3>National film institute</h3>
        </div>
        <div class="blog_carrier">
            <img src="<?= site_url ?>images/rights.jpeg" alt="blog image" 
            onclick="window.location.href='https://www.nigeriarights.gov.ng/'">
            <h3>National Human Rights Commision</h3>
        </div>
        <div class="blog_carrier">
            <img src="<?= site_url ?>images/poly.jpeg" alt="blog image" 
            onclick="window.location.href='https://plapoly.edu.ng/'">
            <h3>Plateau State Polytechnic</h3>
        </div>
    </div>
