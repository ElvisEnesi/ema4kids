...
<body>
    ...
    <?php if (isset($_SESSION['admin_signin'])) : ?>
        <div class="error">
            <?php echo $_SESSION['admin_signin']; ?>
        </div>
    <?php endif; ?>
    ...
    <div class="form">
        <form action="<?= site_url ?>authentication/admin_signin_logic.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="password" id="key" name="admin_key">
            </div>
            <div class="form_group">
                <label for="show_password">Show password</label>
                <input type="checkbox" onclick="showPassword()" id="show_password" name="show_password">
            </div>
            <button type="submit" name="admin_signin">Sign Up</button>
        </form>
        <div class="forgot_password">
            Forgot your password? <a href="<?= site_url ?>authentication/admin_reset_password.php">Click....</a>
        </div>
    </div>
