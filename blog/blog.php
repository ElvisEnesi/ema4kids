...
<body>
    ...
    <div class="ps-hero">
        <div class="ps-hero-tag">ema4kids stories</div>
        <div class="ps-hero-title">Read and enrichen your minds</div>
        <div class="ps-hero-sub">
            We bring about new stories about ema4kids, our youths, and how we empack their lives.
        </div>
    </div>
    <div class="blog_holder">
        <div class="blog_carrier scroll_animation_slide_right" style="--i: 0;">
            <img src="<?= site_url ?>images/WhatsApp Image 2026-04-08 at 15.43.47 (1).jpeg" alt="blog image" 
            onclick="window.location.href='<?= site_url ?>blog/blog_page.php'">
            <div class="blog_date">
                30 August 2026
            </div>
            <h3>Our latest SR</h3>
            <p>
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Perspiciatis debitis libero earum quaerat 
                veritatis.
            </p>
            <div class="author">
                <img class="author_pic" src="<?= site_url ?>images/WhatsApp Image 2026-04-08 at 15.43.47 (1).jpeg" alt="Author pic">
                <span>Elvis Jatto</span>
            </div>
        </div>
    </div>
    <div class="footer scroll_animation_fade" id="footer" style="--i: 0;">
        <div class="col">
            ...
            <a href="<?= site_url ?>scholars.php">Our scholarship recipients</a>
