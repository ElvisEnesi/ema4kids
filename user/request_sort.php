            ...
            <div class="main_navigator">
                ...
                <div class="search">
                    <form action="<?= site_url ?>user/search_request.php" method="get">
                        <input type="search" name="search" placeholder="Type description to search">
            ...
            <?php
                ...
                if (isset($_GET['sort'])) {
                    ...
                    $select_request = mysqli_prepare(
                        $conn,
                        "SELECT * FROM request_tbl WHERE user_uuid = ? ORDER BY date_created $sort"
                    );
                    // bind parameters
                        ...
                        echo "<table>";
                            ...
                            while ($request = mysqli_fetch_assoc($select_request)) {
                                echo "<tr>";
                                    ...
                                    echo "<td>" . htmlspecialchars($request['status'], ENT_QUOTES, 'UTF-8') . "</td>";
