...
<body>
    <div class="dashboard_container">
        ...
        <main>
            ...
            <?php
                // select user's requests from database
                $select_request = mysqli_prepare($conn, "SELECT * FROM request_tbl WHERE user_uuid = ?");
                // bind parametes
                mysqli_stmt_bind_param($select_request, "s", $_SESSION['uuid']);
                // execute statement
