...
<body>
    ...
    <div class="ps-hero">
        <div class="ps-hero-tag">Scholarship Alumni</div>
        <div class="ps-hero-title">Ema4kids Scholarship Recipients</div>
    ...
    <div class="note_to_know scroll_animation_fade" style="--i: 0;">
        <strong>For the Ema4Kids team:</strong> This page is ready to populate with alumni profiles. Each card includes a 
    ...
    <div class="cta-banner">
        ...
        <p>We'd love to feature your story and celebrate your journey. Reach out to share your update with our community.</p>
        </div>
        <a class="cta-btn" href="mailto:ema4kids@gmail.com">Share Your Story</a>
    </div>
